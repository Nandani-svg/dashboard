...
const sections = (guildId: string) => [
    ...
    },
    {
        ...
        links: [
            ...
            { name: "Custom commands", href: `/dashboard/guild/${guildId}/automation`, icon: Gamepad2 },
        ],
    },
    {
        label: "Connections",
        ...
        <aside className="w-full shrink-0 border-b border-card-border bg-secondary lg:sticky lg:top-16 lg:h-[calc(100vh-4rem)] lg:w-64 lg:border-b-0 lg:border-r lg:overflow-y-auto">
            <div className="px-3 pt-3 pb-3">
                ...
                <label className="relative mt-2 block">
                    ...
                    className="h-8 w-full rounded-md border-card-border bg-surface py-1 pl-8 pr-2 text-xs text-white outline-none placeholder:text-slate-600 focus:border-primary"
                    />
                </label>
            </div>

            <nav className="grid grid-cols-2 gap-x-3 gap-y-4 px-3 sm:grid-cols-3 lg:block lg:space-y-4" aria-label="Server controls">
