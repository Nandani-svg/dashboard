...
const defaultConfig = { enabled: 0, max_channel_deletes: 3, max_role_deletes: 3, max_bans: 3, max_kicks: 5, max_wehbook_creates: 2, rate_window_seconds: 15, action_type: "ban", panic_lockdown_enabled: 0};
...
export function AntinukeControl() {
    ...
    const thresholds = [
        { key: "max_channel_deletes", label: "Channel deletions", help: "Mazimum deletions in the window"},
        ...
        { key: "max_kicks", label: "Member kicks", help: "Member kicks in the window" },
        { key: "mac_wehbook_creates", label: "Wehbook creates", help: "Maximum new wehbook in the window"}, 
    ];
